...
public interface DoctorAppointmentController extends AppointmentController {
     ...
     *
     * <p>
     * Appointment requests are those awaiting the doctor's approval or response.</p>
     *
     * @param doctorId The unique identifier of the doctor.
     ...
     *
     * <p>
     * Upcoming appointments are those scheduled in the future that have not been canceled or completed.</p>
     *
     * @param doctorId The unique identifier of the doctor.
